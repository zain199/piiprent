      ...
      children: [
        Padding(
          ...
          child: Obx(() => RadioContainer(
                colorcondition: qcontroller.question6.value == "Yes",
                value: "Yes",
                text: "Yes",
                groupvalue: qcontroller.question6.value,
                onchanged: (val) {
                  qcontroller.question6.value = val;
                },
              )),
        ),
        Padding(
          padding: const EdgeInsets.only(top: 5, left: 16, right: 16),
          child: Obx(() => RadioContainer(
                colorcondition: qcontroller.question6.value == "No",
                value: "No",
                text: "No",
                groupvalue: qcontroller.question6.value,
                onchanged: (val) {
