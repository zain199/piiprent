      ...
      children: [
        Padding(
          ...
          child: Obx(() => RadioContainer(
                colorcondition: qcontroller.question2.value == "Yes",
                value: "Yes",
                text: "Yes",
                groupvalue: qcontroller.question2.value,
                onchanged: (val) {
                  qcontroller.question2.value = val;
                },
              )),
        ),
        Padding(
          padding: const EdgeInsets.only(top: 5, left: 16, right: 16),
          child: Obx(() => RadioContainer(
                colorcondition: qcontroller.question2.value == "No",
                value: "No",
                text: "No",
                groupvalue: qcontroller.question2.value,
                onchanged: (val) {
