      ...
      children: [
        Padding(
          ...
          child: Obx(() => RadioContainer(
                colorcondition: qcontroller.question4.value == "Yes",
                value: "Yes",
                text: "Yes",
                groupvalue: qcontroller.question4.value,
                onchanged: (val) {
                  qcontroller.question4.value = val;
                },
              )),
        ),
        Padding(
          padding: const EdgeInsets.only(top: 5, left: 16, right: 16),
          child: Obx(() => RadioContainer(
                colorcondition: qcontroller.question4.value == "No",
                value: "No",
                text: "No",
                groupvalue: qcontroller.question4.value,
                onchanged: (val) {
